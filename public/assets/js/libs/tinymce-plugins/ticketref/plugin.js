...
;(function (f) {
  ...
  // <script>
    ...
    tinymce.create('tinymce.plugins.Ticketref', {

        init: function (ed) {

            var autoComplete,
                autoCompleteData = ed.getParam('ticketref');
            ...
            function canTriggerAutocomplete(ed) {
            ...
            ed.on('keypress', function (e) {
                ...
                if (delimiterIndex > -1 && canTriggerAutocomplete(ed)) {
    ...
    tinymce.PluginManager.add('ticketref', tinymce.plugins.Ticketref);
